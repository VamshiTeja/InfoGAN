...
def conv2d(inp, num_kernels=32, kernel_size=3, stride=2,activation_fn='relu', stddev=0.02, is_train=True, keep_prob=0.9,name="conv2d",regularisation=None):
	'''
		...
		conv including batch norm and dropout
	'''
...
def deconv2d(inp, num_filters, kernel_size, stride, keep_prob=0.9, is_train=True, name="deconv2d", stddev=0.02,activation_fn='relu', regularisation=None):
	'''
		...
		deconv including batch norm and dropout
	'''
	if(regularisation=="l2"):
		reg = tf.contrib.layers.l2_regularizer
	else:
...
class InfoGAN:
	...
	def add_gaussian_noise(self,X,std=1.0):
		'''
			add gaussian noise to tensor X with specified std 
		'''
	...
	def Generator(self,z,cat,cont):
		'''
			Generator: generates images of size 256x256xNone
		...
		with tf.variable_scope("generator", reuse=self.g_reuse) as scope:
			...
			inp = deconv2d(inp, num_filters=256, kernel_size=5, stride=4, name="project", stddev=0.02,activation_fn='relu')
			conv0 = conv2d(inp, num_kernels=256, kernel_size=5, stride=1,activation_fn='relu', stddev=0.02, is_train=True, name="conv2d_0")

			deconv1_1 = deconv2d(conv0, num_filters=128, kernel_size=5, stride=2, name="deconv2d_11", stddev=0.02,activation_fn='relu')
			conv1_2 =   conv2d(deconv1_1, num_kernels=128, kernel_size=5, stride=1,activation_fn='relu', stddev=0.02, is_train=True, name="conv2d_12")
			#conv1_3 =   conv2d(conv1_2, num_kernels=128, kernel_size=5, stride=1,activation_fn='relu', stddev=0.02, is_train=True, name="conv2d_13")
			conv1_3 =   self.add_gaussian_noise(conv1_2)

			deconv2_1 = deconv2d(conv1_3, num_filters=64, kernel_size=5, stride=2, name="deconv2d_21", stddev=0.02,activation_fn='relu',regularisation=None)
			conv2_2 =   conv2d(deconv2_1, num_kernels=64, kernel_size=5, stride=1,activation_fn='relu', stddev=0.02, is_train=True, name="conv2d_22",regularisation="l2")
			#conv2_3 =   conv2d(conv2_2, num_kernels=64, kernel_size=5, stride=1,activation_fn='relu', stddev=0.02, is_train=True, name="conv2d_23",regularisation="l2")
			conv2_3 =   self.add_gaussian_noise(conv2_2)

			deconv3_1 = deconv2d(conv2_3, num_filters=32, kernel_size=5, stride=2, name="deconv2d_31", stddev=0.02,activation_fn='relu',regularisation=None)
			conv3_2 =   conv2d(deconv3_1, num_kernels=32, kernel_size=5, stride=1,activation_fn='relu', stddev=0.02, is_train=True, name="conv2d_32",regularisation="l2")
			#conv3_3 =   conv2d(conv3_2, num_kernels=32, kernel_size=5, stride=1,activation_fn='relu', stddev=0.02, is_train=True, name="conv2d_33",regularisation=None)
			conv3_3 =   self.add_gaussian_noise(conv3_2)

			deconv4_1 = deconv2d(conv3_3, num_filters=16, kernel_size=3, stride=2, name="deconv2d_41", stddev=0.02,activation_fn='relu',regularisation=None)
			conv4_2 =   conv2d(deconv4_1, num_kernels=16, kernel_size=3, stride=1,activation_fn='relu', stddev=0.02, is_train=True, name="conv2d_42",regularisation="l2")
			#conv4_3 =   conv2d(conv4_2, num_kernels=16, kernel_size=5, stride=1,activation_fn='relu', stddev=0.02, is_train=True, name="conv2d_43",regularisation=None)
			#conv4_2 =   self.add_gaussian_noise(conv4_2)

			deconv5_1 = deconv2d(conv4_2, num_filters=8, kernel_size=3, stride=2, name="deconv2d_51", stddev=0.02,activation_fn='relu')
			conv5_2 =   conv2d(deconv5_1, num_kernels=8, kernel_size=3, stride=1,activation_fn='relu', stddev=0.02, is_train=True, name="conv2d_52")
			#conv5_3 =   conv2d(conv5_2, num_kernels=8, kernel_size=5, stride=1,activation_fn='relu', stddev=0.02, is_train=True, name="conv2d_53")
			#conv5_3 =   self.add_gaussian_noise(conv5_3)

			deconv6_1 = deconv2d(conv5_2, num_filters=4, kernel_size=3, stride=2, name="deconv2d_61", stddev=0.02,activation_fn='relu')
			conv6_2 =   conv2d(deconv6_1, num_kernels=4, kernel_size=3, stride=1,activation_fn='relu', stddev=0.02, is_train=True, name="conv2d_62")
			conv6_3 =   conv2d(conv6_2, num_kernels=self.args.num_channels, kernel_size=3, stride=1,activation_fn='tanh', stddev=0.02, is_train=True, name="conv2d_63")
		self.g_reuse = True	
		return conv6_3
	...
	def shared_layers(self,X):
		...
		with tf.variable_scope("shared",reuse=self.s_reuse):
			conv1_1 = conv2d(X, num_kernels=4, kernel_size=5, stride=1,activation_fn='relu', stddev=0.02, is_train=True, name="conv2d_1_1")
			conv1_2 = conv2d(conv1_1, num_kernels=4, kernel_size=5, stride=2,activation_fn='relu', stddev=0.02, is_train=True, name="conv2d_1_2")

			conv2_1 = conv2d(conv1_2, num_kernels=8, kernel_size=5, stride=1,activation_fn='relu', stddev=0.02, is_train=True, name="conv2d_2_1")
			conv2_2 = conv2d(conv2_1, num_kernels=8, kernel_size=5, stride=2,activation_fn='relu', stddev=0.02, is_train=True, name="conv2d_2_2")

			conv3_1 = conv2d(conv2_2, num_kernels=16, kernel_size=5, stride=1,activation_fn='relu', stddev=0.02, is_train=True, name="conv2d_3_1")
			conv3_2 = conv2d(conv3_1, num_kernels=16, kernel_size=5, stride=2,activation_fn='relu', stddev=0.02, is_train=True, name="conv2d_3_2")

			conv4_1 = conv2d(conv3_2, num_kernels=32, kernel_size=3, stride=1,activation_fn='relu', stddev=0.02, is_train=True, name="conv2d_4_1")
			conv4_2 = conv2d(conv4_1, num_kernels=32, kernel_size=3, stride=2,activation_fn='relu', stddev=0.02, is_train=True, name="conv2d_4_2")

			conv5_1 = conv2d(conv4_2, num_kernels=64, kernel_size=3, stride=1,activation_fn='relu', stddev=0.02, is_train=True, name="conv2d_5_1")
			conv5_2 = conv2d(conv5_1, num_kernels=64, kernel_size=3, stride=2,activation_fn='relu', stddev=0.02, is_train=True, name="conv2d_5_2")

			conv6_1 = conv2d(conv5_2, num_kernels=128, kernel_size=3, stride=1,activation_fn='relu', stddev=0.02, is_train=True, name="conv2d_6_1")
			conv6_2 = conv2d(conv6_1, num_kernels=128, kernel_size=3, stride=2,activation_fn='relu', stddev=0.02, is_train=True, name="conv2d_6_2")

			conv7_1 = conv2d(conv6_2, num_kernels=256, kernel_size=3, stride=1,activation_fn='relu', stddev=0.02, is_train=True, name="conv2d_7_1")
			conv7_2 = conv2d(conv7_1, num_kernels=256, kernel_size=3, stride=2,activation_fn='relu', stddev=0.02, is_train=True, name="conv2d_7_2")

			conv8 = conv2d(conv7_2, num_kernels=256, kernel_size=3, stride=1,activation_fn='relu', stddev=0.02, is_train=True, name="conv2d_8")
		self.s_reuse = True
		return conv8
	...
	def Q(self,X):
		...
		with tf.variable_scope("cat",reuse=self.q_cat_reuse):
			...
			cat_fc2 = tf.layers.dense(cat_fc1, units=n_h2,activation=None,use_bias=True,
					kernel_initializer=tf.truncated_normal_initializer(stddev=0.02),bias_initializer=tf.zeros_initializer())
		...
		with tf.variable_scope("cont",reuse=self.q_cont_reuse):
			...
			cont_fc2 = tf.layers.dense(cont_fc1, units=n_h2,activation=None,use_bias=True,
					kernel_initializer=tf.truncated_normal_initializer(stddev=0.02),bias_initializer=tf.zeros_initializer())
		...
		with self.graph.as_default():
			...
			if(self.args.mode=="dc-gan"):
				if(self.args.smooth_labels==1):
					r_labels = tf.random_uniform(shape=tf.shape(self.D_real),minval=0.9,maxval=1.1)
					f_labels = tf.random_uniform(shape=tf.shape(self.D_fake),minval=0,maxval=0.1)
				else:
				...
				self.G_loss = tf.reduce_mean(tf.nn.sigmoid_cross_entropy_with_logits(labels=r_labels,logits=self.D_fake)) + 0.01*self.G_reg
				self.D_plus_Q_loss = 0.5*self.D_loss + 0.5*self.Q_loss 
				self.G_plus_Q_loss = 0.7*self.G_loss + 0.3*self.Q_loss 

				#define optimizers
				if(args.grad_clip==-1):
					self.D_solver = tf.train.AdamOptimizer(args.learning_rate,beta1=0.5).minimize(self.D_loss, var_list=theta_D, global_step=self.global_step)
					self.G_solver = tf.train.AdamOptimizer(args.learning_rate,beta1=0.5).minimize(self.G_loss, var_list=theta_G)
					self.Q_solver = tf.train.AdamOptimizer(args.learning_rate,beta1=0.5).minimize(self.Q_loss, var_list=theta_Q+theta_G)
				else:
					grads, _ = tf.clip_by_global_norm(tf.gradients(self.D_loss, theta_D), 5)
					...
					grads, _ = tf.clip_by_global_norm(tf.gradients(self.G_loss, theta_G), 5)
					opti = tf.train.AdamOptimizer(args.learning_rate,beta1=0.5)
					self.G_solver= opti.apply_gradients(zip(grads, theta_G), global_step=self.global_step)

					grads, _ = tf.clip_by_global_norm(tf.gradients(self.Q_loss, theta_Q+theta_G),5)
					opti = tf.train.AdamOptimizer(args.learning_rate,beta1=0.5)
